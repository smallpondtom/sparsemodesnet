...
#%% %================= Configuration of SparseModesNet Pi3Net =================%
    ...
    config_dict = {
        ...
        'device': device,
        # Experiment Setup
        'label': "Vertical 3D Channel Flow Pi3Net",
        'enable_logging': True
    }
...
#%% %=======================Plot the omega evolutions =========================%
    smn.omega_evolve(omegas_3, I_nn_3, config.s, save=True, show=False,
                     legend_loc='best',
                     title=r'Vertical: $\omega$ Evolution ($\Pi_3$-Net)',
...
#%% %========== Configuration of SparseModesNet Pi3Net (leading-r) ============%
    ...
    config_dict = {
        ...
        'device': device,
        # Experiment Setup
        'label': "Vertical 3D Channel Flow Pi3Net Leading-r",
        'enable_logging': True
    }
    config = smn.SparseModesNetConfig.from_dict(config_dict)
...
#%% #======================= Plot reconstruction errors =======================#
    ...
    ax.set_title('Vertical: Reconstruction Error vs. Number of Modes', fontsize=30)
...
#%% %============ Plot the reconstructed flow fields (heatmap) ================%
    ...
    plt.suptitle('Sliced Vertical Velocity Reconstruction Comparison', fontsize=29, y=0.98)
    plt.savefig('figures/amr3Dchannel/w/w_recon_recomparison.pdf', dpi=300, bbox_inches='tight')
    # plt.show()
    plt.close(fig)
