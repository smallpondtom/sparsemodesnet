...
plt.savefig('figures/lassonet/quad/select_from_modes/comprehensive_analysis.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig('figures/lassonet/quad/select_from_modes/singular_values.png', dpi=200, bbox_inches='tight')
plt.show()
