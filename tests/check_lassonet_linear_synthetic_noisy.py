...
# %% #========================= Plot the omegas ===============================#
    ...
    plt.tight_layout()
    plt.savefig('figures/lassonet/linear/noisy/omega_evolution.png', dpi=200)
    plt.show()
...
plt.savefig('figures/lassonet/linear/noisy/comprehensive_analysis.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig('figures/lassonet/linear/noisy/singular_values.png', dpi=200, bbox_inches='tight')
plt.show()
